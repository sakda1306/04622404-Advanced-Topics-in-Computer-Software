...
/** Decorative two-rail image corridor. It pauses rather than disappears for reduced motion. */
            ...
            Array.from({ length: cards }, (_, i) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    card,
                    "absolute overflow-hidden shadow-2xl ring-1 ring-white/35",
                  )}
                  style={{
                    left: "50%",
                    top: `${axis}%`,
